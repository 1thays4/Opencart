...
class ControllerSquidfacilImport extends Controller {
    ...
    public function index() {
        $this->load->language('squidfacil/import');
    ...
    protected function getList() {
		...
		$this->data['import'] = $this->url->link('catalog/category/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$category_total = 5; // $this->model_catalog_category->getTotalCategories();
		/*
